...
export const logisticServicesContent = [
  ...
  },
  {
    ...
    minorDesc: "OWe provide distribution services across East Africa, covering countries such as Kenya, Tanzania, Uganda, Rwanda, Ethiopia,and more. Our extensive network ensures seamless transportation within these regions.",
    img: "",
  },
  {
...
export const testimonials = [
  {
    ...
    title: "Client",
    review:
      "I have used Globeflight Worldwide Express to ship my items from India and they provide fast service with great rates. My shipments have always arrived on time and where there have been errors with the shipments of their other clients, they credit your money against your account. I highly recommend them!",
    rating: 5,
  },
  {
    id: 2,
    ...
    review:
      "Glad we are associated with Globeflight Worldwide Express!. As a new customer, we are very happy with the outstanding service provided. Compared to other big forwarding companies, your services were so prompt, efficient and personalized. Every single detail was taken care of from start to end. Caroline was a pleasure to work and was outstanding with follow-up. Looking forwrd to many more shipments with Globeflight!",
    rating: 4,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    title: "",
    review:
      "Globeflight Worldwide Express excels in understanding client needs and providing transparent guidance on my shipments  I'm sincerely thankful to the entire team.",
    rating: 4,
  },
  {
    id: 5,
    ...
    review:
      "Globeflight consolidation services in Kenya are top notch. I was guided through every process, ensuring I understood every step. The process was seamless and smooth",
    rating: 5,
  },
  {
    id: 6,
    ...
    title: "Supply Chain Manager",
    review:
      "I'm grateful for Globeflight and a special thanks to Edwina. My shipment has been done on time.",
    rating: 5,
  },
];
